...
class SimpleGuiPanel(wx.Panel):
    ...
    def _initUi(self):
        ...
        sizer.Add(filenameBox, 1, wx.EXPAND, 1)
        ...
        sizer.Add(self.title, 1, wx.EXPAND, 1)
        ...
        memoBox.Add(self.keyword, 0, wx.ALIGN_CENTER_VERTICAL, 1)
    ...
    def OnLoad(self, filename):
        print("OnLoad")
        fm = FileManager()
        return fm.OnLoad(filename)